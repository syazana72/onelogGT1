...
class FeedBackListSG extends StatefulWidget {
  final Map<String, dynamic> reportData; // Add this line

  FeedBackListSG({required this.reportData}); // Update the constructor

  @override
  _FeedBackState createState() => _FeedBackState();
}
class _FeedBackState extends State<FeedBackListSG> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () =>
              Navigator.push(
                  context, MaterialPageRoute(builder: (_) => MainShowListSG())),
        ),
        centerTitle: true,
        automaticallyImplyLeading: false,
        backgroundColor: Colors.deepOrange[800],
        title: Text('Report List (FEEDBACK)'),
        actions: [
          IconButton(
                ...
                child: Stack(
                  children: [
                    ListTile(
                      ...
                      title: Text(
                        '$index) ${feedbackData['DateAfter']} | ${feedbackData['Location1']}',
                        style: TextStyle(fontWeight: FontWeight.bold),
                      ),
                      subtitle: Text(
                        'PIC: ${feedbackData['Agreed by']}',),
                      ...
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                FullReportAfterSG(feedbackData: feedbackData, reportData: widget.reportData,),
                          ),
                        );
                      },
                    ),
