...
import 'package:afrv1/MainPageSG.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
//import 'package:intl/intl.dart';

class DocumentCountPageSG extends StatefulWidget {
  @override
  _DocumentCountPageState createState() => _DocumentCountPageState();
}

class _DocumentCountPageState extends State<DocumentCountPageSG> {
    ...
    children: <Widget>[
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage('assets/images/backgroundONELOG.png'), // Replace 'assets/background_image.jpg' with your image path
          fit: BoxFit.cover,
        ),
      ),
    ),
    ...
    color: Colors.black.withOpacity(0.3),
      ...
      Scaffold(
        ...
        appBar:AppBar(
          leading: IconButton(
            icon: Icon(Icons.arrow_back),
            onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => MyAppMain2())),
          ),
          centerTitle: true,
          automaticallyImplyLeading: false,
          backgroundColor: Colors.transparent,
                                ...
                                children: [
                                  ...
                                  StreamBuilder<QuerySnapshot>(
                                    stream: FirebaseFirestore.instance
                                        .collection('reports')
                                        .where(FieldPath(['PIC/ATTN']), isEqualTo: 'CKD KR - SAHPARIN')
                                        .snapshots(),
                                    builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot1) {
                                      if (snapshot1.connectionState == ConnectionState.waiting) {
                                        ...
                                        return StreamBuilder<QuerySnapshot>(
                                          stream: FirebaseFirestore.instance
                                              .collection('feedback')
                                              .where(FieldPath(['PIC/ATTN1']), isEqualTo: 'CKD KR - SAHPARIN')
                                              .snapshots(),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 8),
                                  StreamBuilder<QuerySnapshot>(
                                    stream: FirebaseFirestore.instance.collection('reports').where(FieldPath(['PIC/ATTN']), isEqualTo: 'LG BODY - ASNARI').snapshots(),
                                    builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                                      if (snapshot.connectionState == ConnectionState.waiting) {
                                        // Display a loading indicator while fetching the document count
                                        return CircularProgressIndicator();
